...
export default function Game2048() {
  ...
  return (
    <div
      className="flex flex-col items-center justify-center min-h-screen bg-[#faf8ef] text-[#776e65] select-none"
    ...
    >
      ...
      <div className="absolute top-4 left-4">
        <Link href="/" className="flex items-center gap-2 text-[#776e65] hover:text-[#8f7a66] transition-colors">
          <Home size={20} />
      ...
      <div className="w-full max-w-md p-4 flex flex-col items-center">
        <div className="flex justify-between items-center mb-4 w-full">
          ...
          <div className="flex gap-2">
            <div className="bg-[#bbada0] p-2 h-14 w-16 rounded-md text-white flex flex-col items-center justify-center">
              <div className="text-xs">スコア</div>
              <div className="font-bold text-sm">{score}</div>
            </div>
            <div className="bg-[#bbada0] h-14 w-16 rounded-md p-2 text-white flex flex-col items-center justify-center">
        ...
        <div className="bg-[#bbada0] p-2 rounded-lg w-fit touch-none">
          <div
            className="relative"
            style={{
        ...
        <div className="mt-4 text-sm text-center px-2">
          <p>
            <strong>遊び方：</strong> <strong>矢印キー</strong>または<strong>スワイプ</strong>
            でタイルを動かします。同じ数字のタイルが触れると<strong>合体</strong>します！
          </p>
        </div>
