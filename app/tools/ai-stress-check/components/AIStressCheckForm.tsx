...
import type { AIStressCheckAnswers } from "../lib/types"
import { questions } from "../lib/questions"

interface AIStressCheckFormProps {
  answers: AIStressCheckAnswers
  currentQuestion: number
  onUpdateAnswer: (questionId: keyof AIStressCheckAnswers, answer: string) => void
  onNextQuestion: () => void
  onPreviousQuestion: () => void
  isAnalyzing: boolean
}

export function AIStressCheckForm({ 
  answers, 
  currentQuestion, 
  onUpdateAnswer, 
  onNextQuestion, 
  onPreviousQuestion,
  isAnalyzing 
}: AIStressCheckFormProps) {

  // 質問が範囲外の場合（AI分析中または完了）
