...
// メタデータをクライアントコンポーネントで使用できないため、別ファイルに移動
// metadata.ts ファイルを作成する必要があります
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:image" content="https://yokaunit.com/ogp/chinchiro-game.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="チンチロゲーム | 無料オンラインサイコロゲーム - YokaUnit" />
        <meta
          name="twitter:description"
          content="3つのサイコロを振って役を作る日本の伝統的なゲーム。ピンゾロ、ゾロ目、シゴロなどの役を揃えて遊べる無料オンラインゲーム。"
        />
        <meta name="twitter:image" content="https://yokaunit.com/ogp/chinchiro-game.png" />
      ...
      <main className="min-h-screen">
        <div className="container mx-auto px-4 py-6">
              ...
              <Card className="shadow-md border-0">
                ...
                <CardContent className="p-3">
                  <div className="space-y-4">
                    <p>
                      チンチロは日本の伝統的なサイコロゲームで、3つのサイコ口を振って出た目の組み合わせで勝敗を決めます。
                    </p>

                    <div>
                      <h3 className="font-bold mb-2">役の一覧（強い順）</h3>
                      <div className="space-y-2">
                        <div className="flex items-center gap-2">
                          <Badge className="bg-red-500">最強</Badge>
                          <span className="font-medium">ピンゾロ（1-1-1）</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Badge className="bg-blue-500">強い</Badge>
                          <span className="font-medium">ゾロ目（同じ数字が3つ）</span>
                          <span className="text-sm text-gray-500">例: 2-2-2, 3-3-3, ...</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Badge className="bg-green-500">強い</Badge>
                          <span className="font-medium">シゴロ（4-5-6）</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Badge className="bg-yellow-500">普通</Badge>
                          <span className="font-medium">通常の目（同じ数字が2つ）</span>
                          <span className="text-sm text-gray-500">
                            残りの1つの数字が役の価値（例: 2-2-3なら「3の目」）
                          </span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Badge className="bg-gray-500">負け</Badge>
                          <span className="font-medium">ヒフミ（1-2-3）</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Badge className="bg-gray-500">負け</Badge>
                          <span className="font-medium">ブタ（それ以外の組み合わせ）</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Badge className="bg-gray-500">負け</Badge>
                          <span className="font-medium">しょんべん（サイコロが器から出る）</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <ol className="list-decimal list-inside space-y-1">
                        <li>「サイコロを振る」ボタンをクリックしてサイコロを振ります</li>
                        <li>3つのサイコロが止まると、自動的に役が判定されます</li>
                        <li>「リセット」ボタンでサイコロの位置をリセットできます</li>
                        <li>「現在位置から回す」をオンにすると、サイコロの現在位置から振ることができます</li>
                      </ol>
                    </div>
          ...
          <div className="prose max-w-none">
            <h2>チンチロゲームについて</h2>
            <p>
              チンチロ（丁半）は、日本の伝統的なサイコロゲームで、賭博として知られていますが、このツールでは純粋に楽しむためのゲームとして提供しています。3つのサイコロを振って出た目の組み合わせによって勝敗が決まります。
            </p>

            <h3>チンチロの歴史</h3>
            <p>
              チンチロの起源は江戸時代にさかのぼり、当時は「丁半博打」として知られていました。「丁（チョウ）」と「半（ハン）」の2つの目を賭けるゲームだったことが名前の由来です。現代では、3つのサイコロを使用するバージョンが一般的になっています。
            </p>

            <h3>オンラインチンチロゲームの特徴</h3>
            <ul>
              <li>リアルな3Dサイコロの物理演算</li>
              <li>スマートフォンでも快適にプレイ可能</li>
              <li>役の判定が自動で行われる</li>
              <li>履歴機能で過去の結果を確認できる</li>
              <li>友達と共有して一緒に楽しめる</li>
            </ul>

            <h3>チンチロの楽しみ方</h3>
            <p>
              このゲームは単純ながらも奥深く、運の要素が強いため、誰でも気軽に楽しむことができます。友人や家族と一緒にプレイして、誰が最も運が良いかを競い合うのも面白いでしょう。また、役の出る確率を考えながらプレイすることで、確率論的な思考力も養えます。
            </p>

            <h3>注意事項</h3>
            <p>
              このゲームは娯楽目的で提供されており、実際の金銭や物品を賭けることを推奨するものではありません。健全な範囲でお楽しみください。
            </p>
          </div>
        </div>
      </main>
