...
export const SEO_METADATA = {
  title: '消費税計算機｜税込・税抜・税額を瞬時に計算｜無料で使いやすい - YokaUnit',
  description: '消費税10%・8%の計算が一瞬でできる無料ツール。税込価格から税抜価格、税抜価格から税込価格、税額のみの計算に対応。スマホ・PCどちらでも使いやすく、履歴保存・CSV出力機能付き。経理・会計・日常の買い物に便利。',
  keywords: [
    '消費税計算機',
    '消費税計算',
    '税込み計算',
...
export const FAQ_STRUCTURED_DATA = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'はい、計算履歴はブラウザのローカルストレージに自動保存され、最大100件まで保存できます。CSVファイルとしてダウンロードも可能で、Excelで開いて管理できます。'
      }
    },
    {
      '@type': 'Question',
