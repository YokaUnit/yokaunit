...
export function WarikanClient() {
  ...
  useEffect(() => {
    ...
    const structuredData = {
      ...
      "@type": "WebApplication",
      "name": "割り勘計算機",
      "description": "人数・金額・端数処理を自動計算する無料オンライン計算機",
      ...
      "screenshot": "https://yokaunit.com/ogp/warikan-calculator.png",
      "softwareVersion": "1.0",
  ...
  return (
    <div className="max-w-md mx-auto mt-6">
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl md:text-4xl font-bold text-gray-900 mb-2">割り勘計算機</h1>
        <p className="text-gray-600 text-base md:text-lg">{step === "calculate" ? "人数・金額・端数処理を自動計算" : "精算方法を計算"}</p>
        ...
        <>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-md p-4 text-center">
              ...
              <p className="text-sm font-semibold text-gray-700">自動計算</p>
            </Card>
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-md p-4 text-center">
              <div className="text-2xl mb-2">💸</div>
      ...
      <div className="mt-8 text-xs text-gray-500 space-y-2">
        <p>
          <strong>割り勘計算機</strong>は、人数・金額・端数処理を自動計算する無料オンライン計算機です。
        ...
        <p>
          <strong>キーワード:</strong> 割り勘 計算 アプリ 無料 登録不要 精算 飲み会 ランチ 旅行 スマホ ツール 割り勘計算機 支払い 送金
        </p>
      </div>
    </div>
  )
